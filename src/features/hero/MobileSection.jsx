...
export const MobileSection = ({ onNavigateToDashboard }) => {
  ...
  useEffect(() => {
    const timer1 = setTimeout(() => setHeadingVisible(true), ANIMATION_DELAYS.heading);
    const timer2 = setTimeout(() => setParagraphVisible(true), ANIMATION_DELAYS.paragraph);
    const timer3 = setTimeout(() => setButtonVisible(true), ANIMATION_DELAYS.button);
    const timer4 = setTimeout(() => setImageVisible(true), ANIMATION_DELAYS.image);
  ...
  return (    <section className="bg-transparent dark:bg-transparent relative overflow-hidden min-h-[600px] flex flex-col">
      ...
      <div className="relative z-10 grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 flex-grow">
        <div className="mr-auto place-self-center lg:col-span-6">          <h1
          ...
          </p>          {/* Botón que navega al dashboard */}
          <div 
        ...
        <div className="hidden lg:mt-0 lg:col-span-6 lg:flex justify-center items-center rounded-lg overflow-hidden">
          <img
            ...
            alt="Flujo de automatización en acción"            className={`w-[500px] h-[350px] rounded-2xl border-white border-4 rotate-3 transform hover:-translate-y-2
